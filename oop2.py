...
## Banking application : banking operations Deposit/Withdraw

# Instance variable : Name, Amount, Address, AccountNo
# Instance method : CreateAccount(), DisplayAccountInfo()
# Class variable : Bank_Name ,ROI_On_FD   -------------------Common for all
...
def main():
    ...
    print("Amount of {} after deposit is {}: ".format(User1.Name,User1.Amount))  # asses the instance variable by obj.variable name
